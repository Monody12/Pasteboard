...
data class ApiResponse<T>(
    ...
    companion object {
        ...
        fun systemError(msg: String): ApiResponse<Nothing?> {
            return ApiResponse(500, msg, null)
        }

        fun paramError(msg: String): ApiResponse<Nothing?> {
            return ApiResponse(400, msg, null)
        }

        fun unauthorized(msg: String): ApiResponse<Nothing?> {
            return ApiResponse(401, msg, null)
        }

        fun forbidden(msg: String): ApiResponse<Nothing?> {
            return ApiResponse(403, msg, null)
        }

        fun notFound(msg: String): ApiResponse<Nothing?> {
